 ...
 * Homepage: https://shopilo.it/negozi/topfarmacia.it
 */

const SHOPILO_URL = "https://shopilo.it/negozi/topfarmacia.it";
const STORE_NAME  = "TopFarmacia";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-it/codice-sconto-topfarmacia)" }
  });
