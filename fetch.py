#!/usr/bin/env python3
"""
Recupero codici sconto TopFarmacia da shopilo.it
Sursa: https://shopilo.it/negozi/topfarmacia.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/topfarmacia.it"
STORE_NAME = "TopFarmacia"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per TopFarmacia da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-topfarmacia)"
    }
    try:
